...
import { CreateResumeElementService } from './CreateResumeElement.service';
import 'rxjs/add/operator/toPromise';
@Component({
	selector: 'app-CreateResumeElement',
	templateUrl: './CreateResumeElement.component.html',
	styleUrls: ['./CreateResumeElement.component.css'],
  providers: [CreateResumeElementService]
})
export class CreateResumeElementComponent implements OnInit {
  ...
  constructor(private serviceCreateResumeElement:CreateResumeElementService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    let tempList = [];
    return this.serviceCreateResumeElement.getAll()
    .toPromise()
    .then((result) => {
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: "hansung.ac.kr.transaction.CreateResumeElement",
    ...
    return this.serviceCreateResumeElement.addTransaction(this.Transaction)
    .toPromise()
    .then(() => {
			this.errorMessage = null;
      this.myForm.setValue({
   ...
   updateTransaction(form: any): Promise<any> {
    ...
    return this.serviceCreateResumeElement.updateTransaction(form.get("transactionId").value,this.Transaction)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceCreateResumeElement.deleteTransaction(this.currentId)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
  ...
  getForm(id: any): Promise<any>{
    ...
    return this.serviceCreateResumeElement.getTransaction(id)
    .toPromise()
    .then((result) => {
			this.errorMessage = null;
      let formObject = {
