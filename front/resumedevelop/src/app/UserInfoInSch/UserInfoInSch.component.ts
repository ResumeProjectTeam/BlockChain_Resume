...
export class UserInfoInSchComponent implements OnInit {
  ...
  private currentId;
	private errorMessage;
          ...
          issuingSch = new FormControl("", Validators.required);
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      $class: "hansung.ac.kr.assets.UserInfoInSch",
          ...
          "issuingSch":this.issuingSch.value,
  ...
  getForm(id: any): Promise<any>{
    ...
    .then((result) => {
      ...
      let formObject = {
        ...
        if(result.issuingSch){
          
            formObject.issuingSch = result.issuingSch;
          
        }else{
          formObject.issuingSch = null;
        }
