...
export class ResumeInfoUserComponent implements OnInit {
  ...
  private currentId;
	private errorMessage;
          ...
          certificateList = new FormControl("", Validators.required);
        
  
      
          awardList = new FormControl("", Validators.required);
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      $class: "hansung.ac.kr.assets.ResumeInfoUser",
          ...
          "certificateList":this.certificateList.value,
        
      
        
          "awardList":this.awardList.value,
  ...
  getForm(id: any): Promise<any>{
    ...
    .then((result) => {
      ...
      let formObject = {
        ...
        if(result.certificateList){
          
            formObject.certificateList = result.certificateList;
          
        }else{
          formObject.certificateList = null;
        }
      
        if(result.awardList){
          
            formObject.awardList = result.awardList;
          
        }else{
          formObject.awardList = null;
        }
